...
import IntroSection from "./components/first-page/introsection"; 
...
const Hero = () => {
  ...
  return (
    <>
      {!showSection ? (
        <IntroSection handleShowSection={handleShowSection} /> 
      ) : (
        <section
          id="main-section"
        ...
        >
          <div className="flex items-center justify-center flex-col pt-[40px] sm:pt-[60px] md:pt-[70px]">
            ...
            <p className="px-[20px] text-sm sm:text-base md:text-lg mt-2 sm:mt-3 md:mt-4">
